...
// ==========================================
// 1. FUNGSI GLOBAL LOADER (BISA DIPANGGIL MANUAL)
// ==========================================
// Kita daftarkan ke 'window' agar bisa dipanggil lewat Javascript biasa di mana saja
...
// Kita buatkan event listener agar bisa dipanggil lewat Alpine.js atau Livewire $dispatch
window.addEventListener('trigger-show-loader', () => window.showLoader());
window.addEventListener('trigger-hide-loader', () => window.hideLoader());


// ==========================================
// 2. KONFIGURASI SPESIFIK LIVEWIRE
// ==========================================
