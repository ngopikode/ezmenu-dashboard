<div>
    ...
    @if(!$restaurant)
        <div class="alert alert-warning border-0 shadow-sm rounded-4" role="alert">
            <h4 class="alert-heading fw-bold"><i class="bi bi-exclamation-triangle-fill me-2"></i> Belum ada Restaurant!
            </h4>
            <p>Anda belum mengatur informasi restoran anda. Silahkan atur sekarang untuk mulai menerima pesanan.</p>
            <hr>
            <p class="mb-0"><a href="{{ route('settings.index') }}" class="btn btn-sm btn-dark rounded-pill">Atur
                    Restoran Sekarang</a></p>
        </div>
    @else
                ...
                <div class="card border-0 shadow-sm rounded-4 h-100">
                    <div class="card-header border-0 pt-4 px-4 pb-0 d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('orders.index') }}"
                           class="btn btn-sm btn-light rounded-pill px-3 text-muted border">Lihat Semua</a>
                    </div>
                    <div class="card-body p-4">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center py-5 text-muted">Belum ada pesanan terbaru.
                                        </td>
                                    </tr>
                                @endforelse
                                </tbody>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-grid gap-2">
                            <a href="{{ route('menu.index') }}"
                               class="btn btn-outline-secondary rounded-pill px-3 py-2 text-start border bg-light text-dark">
