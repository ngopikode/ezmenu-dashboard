                ...
                <div class="card-body p-2">
                    <nav class="nav nav-pills flex-column gap-1">
                        <button wire:click="$set('activeTab', 'general')"
                                class="nav-link rounded-pill text-start px-4 py-3 {{ $activeTab == 'general' ? 'active bg-dark' : 'text-muted' }}">
                            <i class="bi bi-shop me-2"></i> Informasi Umum
                        </button>
                        <button wire:click="$set('activeTab', 'hero')"
                                class="nav-link rounded-pill text-start px-4 py-3 {{ $activeTab == 'hero' ? 'active bg-dark' : 'text-muted' }}">
                            <i class="bi bi-image me-2"></i> Hero Section
                        </button>
                        <button wire:click="$set('activeTab', 'navbar')"
                                class="nav-link rounded-pill text-start px-4 py-3 {{ $activeTab == 'navbar' ? 'active bg-dark' : 'text-muted' }}">
                            <i class="bi bi-layout-text-sidebar me-2"></i> Navbar
                        </button>
                        <button wire:click="$set('activeTab', 'seo')"
                                class="nav-link rounded-pill text-start px-4 py-3 {{ $activeTab == 'seo' ? 'active bg-dark' : 'text-muted' }}">
                            <i class="bi bi-search me-2"></i> SEO
                        </button>
                        <button wire:click="$set('activeTab', 'qrcode')"
                                class="nav-link rounded-pill text-start px-4 py-3 {{ $activeTab == 'qrcode' ? 'active bg-dark' : 'text-muted' }}">
                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body p-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <div
                                            class="rounded-circle bg-light shadow-sm overflow-hidden d-flex align-items-center justify-content-center position-relative"
                                            style="width: 80px; height: 80px;">
                                            @if($form->logo)
                                                <img src="{{ $form->logo->temporaryUrl() }}"
                                                     class="w-100 h-100 object-fit-cover">
                                            @elseif($form->existingLogo)
                                                <img src="{{ asset('storage/' . $form->existingLogo) }}"
                                                     class="w-100 h-100 object-fit-cover">
                                            @else
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control rounded-pill"
                                           wire:model="form.restaurantName" placeholder="Nama restoran anda">
                                    @error('form.restaurantName') <span
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control rounded-start-pill"
                                               wire:model="form.subdomain" placeholder="nama-resto">
                                        <span
                                            class="input-group-text rounded-end-pill bg-light text-muted small">.{{ config('app.frontend_url_base') }}</span>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control rounded-pill"
                                           wire:model="form.whatsappNumber" placeholder="628xxxxxxxxx">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <input type="color"
                                               class="form-control form-control-color rounded-circle border-0 shadow-sm"
                                               wire:model="form.themeColor" style="width: 40px; height: 40px;">
                                        <input type="text" class="form-control rounded-pill"
                                               wire:model="form.themeColor" placeholder="#F50057"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control rounded-4" rows="2" wire:model="form.address"
                                              placeholder="Alamat lengkap restoran..."></textarea>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-check form-switch">
                                        ...
                                        <label class="form-check-label" for="activeSwitch">Restoran Aktif (terlihat di
                                            client)</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        @if($activeTab == 'hero')
                            ...
                            <p class="text-muted small mb-4">Konfigurasi tampilan bagian utama halaman menu client
                                anda.</p>

                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label small text-muted fw-bold">Promo Text</label>
                                    <input type="text" class="form-control rounded-pill" wire:model="form.heroPromoText"
                                           placeholder="Contoh: Diskon 20%!">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small text-muted fw-bold">Status Text</label>
                                    <input type="text" class="form-control rounded-pill"
                                           wire:model="form.heroStatusText" placeholder="Contoh: Buka Sekarang">
                                </div>
                                <div class="col-12">
                                    <label class="form-label small text-muted fw-bold">Headline</label>
                                    <input type="text" class="form-control rounded-pill" wire:model="form.heroHeadline"
                                           placeholder="Contoh: Lezatnya Masakan Nusantara">
                                </div>
                                <div class="col-12">
                                    <label class="form-label small text-muted fw-bold">Tagline</label>
                                    <input type="text" class="form-control rounded-pill" wire:model="form.heroTagline"
                                           placeholder="Contoh: Cita rasa autentik untuk semua">
                                </div>
                                <div class="col-12">
                                    <label class="form-label small text-muted fw-bold">Instagram URL</label>
                                    <input type="url" class="form-control rounded-pill"
                                           wire:model="form.heroInstagramUrl"
                                           placeholder="https://instagram.com/namaresto">
                                </div>
                            </div>
                        @endif
                        ...
                        @if($activeTab == 'navbar')
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control rounded-pill"
                                           wire:model="form.navbarBrandText" placeholder="Contoh: EZ">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small text-muted fw-bold">Title</label>
                                    <input type="text" class="form-control rounded-pill" wire:model="form.navbarTitle"
                                           placeholder="Contoh: Warung Makan XYZ">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small text-muted fw-bold">Subtitle</label>
                                    <input type="text" class="form-control rounded-pill"
                                           wire:model="form.navbarSubtitle" placeholder="Contoh: Delivery & Dine-In">
                                </div>
                            </div>
                        @endif
                        ...
                        @if($activeTab == 'seo')
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control rounded-pill" wire:model="form.seoTitle"
                                           placeholder="Judul untuk mesin pencari">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small text-muted fw-bold">Keywords</label>
                                    <input type="text" class="form-control rounded-pill" wire:model="form.seoKeywords"
                                           placeholder="restoran, makanan, delivery">
                                </div>
                                <div class="col-12">
                                    <label class="form-label small text-muted fw-bold">SEO Description</label>
                                    <textarea class="form-control rounded-4" rows="2" wire:model="form.seoDescription"
                                              placeholder="Deskripsi singkat restoran anda..."></textarea>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control rounded-pill" wire:model="form.ogTitle"
                                           placeholder="Judul untuk social media share">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small text-muted fw-bold">OG Image</label>
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="rounded-4 bg-light shadow-sm overflow-hidden position-relative"
                                             style="width: 100px; height: 60px;">
                                            @if($form->ogImage)
                                                <img src="{{ $form->ogImage->temporaryUrl() }}"
                                                     class="w-100 h-100 object-fit-cover">
                                            @elseif($form->existingOgImage)
                                                <img src="{{ asset('storage/' . $form->existingOgImage) }}"
                                                     class="w-100 h-100 object-fit-cover">
                                            @else
                                                <div
                                            ...
                                            @endif
                                            <input type="file" wire:model="form.ogImage"
                                                   class="position-absolute top-0 start-0 w-100 h-100 opacity-0"
                                                   style="cursor: pointer;">
                                        </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control rounded-4" rows="2" wire:model="form.ogDescription"
                                              placeholder="Deskripsi untuk preview di social media..."></textarea>
                                </div>
                            </div>
                        @endif
                        ...
                        @if($activeTab == 'qrcode')
                            ...
                            @if($hasRestaurant && $form->subdomain)
                                <div class="text-center py-4">
                                    <div id="qrcode-container"
                                         class="d-inline-block p-4 bg-white rounded-4 shadow-sm border">
                                        {{-- QR Code will be generated here --}}
                                    </div>
                                    <p class="text-muted small mt-3">
                                        <i class="bi bi-link-45deg me-1"></i>
                                        <a href="https://{{ $form->subdomain }}.{{ config('app.frontend_url_base') }}"
                                           target="_blank" class="text-decoration-none">
                                            https://{{ $form->subdomain }}.{{ config('app.frontend_url_base') }}
                                        </a>
                                    </p>
                                ...
                                <script>
                                    function generateQR() {
                                        ...
                                        if (container) {
                                            ...
                                            new QRCode(container, {
                                                text: "https://{{ $form->subdomain }}.{{ config('app.frontend_url_base') }}",
                                                width: 250,
                                                height: 250,
                                                colorDark: '#000000',
                                                colorLight: '#ffffff',
                                    ...
                                    function downloadQR() {
                                        ...
                                        if (img) {
                                            ...
                                            link.download = 'qrcode-{{ $form->subdomain }}.png';
                                            link.href = img.src;
                            ...
                            @else
                                <div class="text-center py-5 text-muted">
                                    ...
                                    <p class="mt-3">Simpan pengaturan restoran terlebih dahulu untuk generate QR
                                        Code.</p>
                                </div>
                            @endif
                        @endif
