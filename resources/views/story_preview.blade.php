...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-md w-full bg-white rounded-3xl shadow-2xl overflow-hidden relative">
        ...
        <div class="relative h-96">
            ...
            <div class="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-sm font-semibold text-gray-800 shadow-lg">
                📍 {{ $restaurant->name }}
            </div>
        </div>
        ...
        <div class="p-6 -mt-10 relative z-10 bg-white rounded-t-3xl">
            ...
            <!-- Action Buttons -->
            <div class="space-y-3">
                <button onclick="handleShare()" class="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-xl shadow-lg transition transform active:scale-95 flex items-center justify-center gap-2">
